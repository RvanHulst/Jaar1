...
function level5() {
	console.log("Level 5");
	gameImage.src="images/.jpg"
	title.innerHTML="level5";
	description.innerHTML="description";
	button2.onclick=death;
	button2.innerHTML="dood keuzen";
	button3.onclick=level6;
	button3.innerHTML="volgende level";
}
...
function level6() {
	...
	button2.onclick=alternatievenKeuzen2;
	button2.innerHTML="alternatieven Keuzen 2";
	button3.onclick=functionlevel7;
	button3.innerHTML="volgende level";
}
